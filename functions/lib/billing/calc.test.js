...
describe("billing calculations", () => {
    test("exclusive vs inclusive tax", () => {
        ...
        const exclusive = (0, calc_1.computeTotals)(lines, taxesById, "exclusive");
        ...
        const inclusive = (0, calc_1.computeTotals)(lines, taxesById, "inclusive");
    ...
    test("percent vs amount discount", () => {
        const percentDiscount = (0, calc_1.computeLineItem)({ ...baseLine, discountType: "percent", discountValue: 10 }, 0, "exclusive");
        expect(percentDiscount.discountMinor).toBe(1000);
        expect(percentDiscount.totalMinor).toBe(9000);
        const amountDiscount = (0, calc_1.computeLineItem)({ ...baseLine, discountType: "amount", discountValue: 2500 }, 0, "exclusive");
    ...
    test("rounding edge case", () => {
        ...
        const computed = (0, calc_1.computeLineItem)(line, 0, "exclusive");
